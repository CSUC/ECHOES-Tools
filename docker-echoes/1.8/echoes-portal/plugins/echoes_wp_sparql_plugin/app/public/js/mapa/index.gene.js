...
var smallIconRed = new L.Icon({

                        iconSize: [48, 48],
                        iconAnchor: [13, 27],
                        popupAnchor:  [1, -24],
                        iconUrl: 'https://echoes.community/wp-content/plugins/echoes_wp_sparql_plugin/app/public/js/mapa/markers/icons8-marker-filled-48_red.png'
...
geoLayer3 = L.geoJSON(infoGene, {
	...
	if (feature.properties.showby.length == 0) {
                return (feature.id.includes("Arque"));
	}
    },
    pointToLayer: function(feature, latlng) {
...
geoLayer4 = L.geoJSON(infoGene, {
    filter: function(feature, layer) {
	if (feature.properties.showby.length == 0) {
                return (feature.id.includes("Arqui"));
	}
    },
    pointToLayer: function(feature, latlng) {
		feature.properties.myKey = feature.properties.title + ', ' + feature.properties.label;
                return L.marker(latlng, {icon: smallIconRed});
            },
    onEachFeature: onEachFeatureGene
});

geoLayer5 = L.geoJSON(infoGene, {
    filter: function(feature, layer) {
        if (feature.properties.showby.length != 0) {
                return (feature.id.includes("Arque"));
        }
...
var layers = 
{       
	"Gencat Archeology" : geoLayer3,
	"Gencat Archeology Enrichment by Calaix" : geoLayer5,
	"Gencat Architecture" : geoLayer4,
	"Gencat Architecture Enrichment by Calaix" : geoLayer6
}
...
mcgLayerSupportGroup.checkIn([geoLayer3, geoLayer4, geoLayer5, geoLayer6]);
...
var fuse = new Fuse(infoGene.features, fuseOptions);

var searchControl = new L.Control.Search({
       layer: L.featureGroup([geoLayer3, geoLayer4, geoLayer5, geoLayer6]),
