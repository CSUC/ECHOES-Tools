...
class EchoesWpSparqlPluginSettings extends MvcSettings {
  ...
  var $settings = array(
    'sparql_endpoint' => array(
      ...
      'label' => 'Endpoint Blazegraph (use {namespace} placeholder for namespace)'
    ),
    ...
    'elastic_endpoint' => array(
      'type' => 'text',
      'default' => '',
      'label' => 'Endpoint Elastic'
    ),
    'elastic_port' => array(
      'type' => 'text',
      'default' => '',
    ...
    'elastic_scheme' => array(
      'type' => 'text',
      'default' => '',
      'label' => 'Elastic Scheme (http/https)'
    )
  );
