...
public class ParserResultsDAOImplTest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		results.setJson(Arrays.asList(new ParserResultsJSON("ns1:date[@calendar and @era and @normal]", 173, "/ns1:ead[@audience]/ns1:archdesc[@level and @type]/ns1:dsc[@type]/ns1:c01[@level]/ns1:c02[@level and @otherlevel]/ns1:c03[@level]/ns1:accessrestrict[@type]/ns1:p/ns1:date[@calendar and @era and @normal]")));
