package org.csuc.echoes.gui.consumer.publish.cli;

import org.apache.logging.log4j.LogManager;
import org.apache.logging.log4j.Logger;
import org.csuc.echoes.gui.consumer.publish.PublishQueueConsumer;
...
public class Consumer {
    ...
    public static void main(String[] args) {
        ...
        try {
            PublishQueueConsumer analyseQueueConsumer = new PublishQueueConsumer(rabbitMQConfig.getLoader());
