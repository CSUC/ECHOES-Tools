package org.csuc.analyse.strategy.dom4j;
...
public class Dom4j implements ParserMethod {
    ...
    private Result createObject(){
        ...
        values.forEach((String xpath, String value) -> {
            org.csuc.analyse.util.xml.Node node = new org.csuc.analyse.util.xml.Node();
        ...
        namespace.forEach((String uri, String prefix)->{
            org.csuc.analyse.util.xml.Namespace namespace = new org.csuc.analyse.util.xml.Namespace();
